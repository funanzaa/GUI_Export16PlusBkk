...
from (
	...
	,case when char_length(trim(dup_vital_sign_extend.main_symptom)) > 255
		then substring(trim(dup_vital_sign_extend.main_symptom),1,255)
		when trim(dup_vital_sign_extend.main_symptom) = '' then null
